...
public class Application {
	...
	public static void main(String[] args) {
		...
		VehicleInsurance vehicleB = new VehicleInsurance (432011,"RAMESH",4,100000,2,2016,20000);
		VehicleInsurance vehicleC = new VehicleInsurance (432146,"RAKESH",1,100000,4,2019,20000);
		VehicleInsurance vehicleD = new VehicleInsurance (43210,"RADHA",4,100000,4,2015,20000);
